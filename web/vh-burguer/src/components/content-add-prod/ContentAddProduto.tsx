...
import styles from '@/components/content-add-prod/ContentAddProduto.module.css'
            ...
            <form action="" id={styles.form_add_prod}>
                <div className={styles.container_form}>
                    ...
                    <div className={styles.content_label}>
                        ...
                        <Link href='/categoria' id={styles.link_categoria}>Adicionar categoria</Link>
                    </div>

                    <div className={styles.content_label}>
                        <label htmlFor="url-img" className='label'>URL da image</label>
